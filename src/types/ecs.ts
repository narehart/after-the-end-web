...
export interface DestroyItemProps {
  entityId: EntityId;
}

export interface MergeItemsProps {
...
export interface MoveItemContextProps {
  itemEntity: Entity;
  sourceGridEntity: Entity;
  targetGridEntity: Entity;
}

export interface SplitItemContextProps {
  itemEntity: Entity;
  targetGridEntity: Entity;
}
