...
import type { MenuContext, MenuPathSegment, MenuLevel } from '../types/inventory';
...
export default function useMenuLevels(path: MenuPathSegment[], context: MenuContext): MenuLevel[] {
